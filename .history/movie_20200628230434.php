                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4 col-md-push-1" style="height: 100%;">
                            <div class="movie-img" style="text-align: center;">
                                <img src="assets/images/photo-manipulation-1825450.jpg" style="max-width: 25%; max-height: 100%;" alt="">
                            </div>
                        </div>
                ...
                <div class="movie-inside">
                    <div class="row">
                        <div class="col-sm-12 col-md-4">
                            <div class="movie-img">
                                <img src="assets/images/photo-manipulation-1825450.jpg" style="max-width: 20%; max-height: 100%;" alt="">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-8">
                            <div class="movie-txt">
