<footer class="page-footer font-small blue pt-4 bg-light footer-link">
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-md-0 mb-3">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a href="#" style="text-decoration: none; color: grey;">A New Sports Movie 1 <span style="float: right"><i class="fas fa-angle-right"></i></span></a>
                        <br>
